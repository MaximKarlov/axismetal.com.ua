const nameProduct = [
    ...
    { id: '11', ukrVer: 'Комплект формовки на термоформер', ruVer: 'Комплект формовки на термоформер' },
    { id: '12', ukrVer: 'Комплект запайки на термоформер ', ruVer: ' Комплект запайки на термоформер' },
    {
        id: '13',
